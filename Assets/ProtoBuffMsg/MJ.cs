...
namespace packet.mj
{
  ...
  public partial class GameOperPlayerActionNotify : global::ProtoBuf.IExtensible
  {
    ...
    private int _gangArg = default(int);
    [global::ProtoBuf.ProtoMember(10, IsRequired = false, Name = @"gangArg", DataFormat = global::ProtoBuf.DataFormat.ZigZag)]
    [global::System.ComponentModel.DefaultValue(default(int))]
    public int gangArg
    {
        get { return _gangArg; }
    ...
    private int _angangArg = default(int);
    [global::ProtoBuf.ProtoMember(11, IsRequired = false, Name = @"angangArg", DataFormat = global::ProtoBuf.DataFormat.ZigZag)]
    [global::System.ComponentModel.DefaultValue(default(int))]
    public int angangArg
    {
        get { return _angangArg; }
        set { _angangArg = value; }
    }
