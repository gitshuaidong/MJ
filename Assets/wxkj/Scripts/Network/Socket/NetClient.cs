...
public class NetClient
{
    ...
    /// <summary>
    /// 
    public bool HallSocketSucess = false;
    public bool MsgSocketSucess = false;
    public bool GameSocketSucess = false;

    public bool onlineHallSocket = true;
    public bool onlineMsgSocket = true;
    public bool onlineGameSockett = true;
    ...
    private void AsyncAccept2(IAsyncResult reuslt)
    {
        ...
        if(port == 5000) HallSocketSucess = true;
        if (port == 4000) MsgSocketSucess = true;
        if (port == 7000) GameSocketSucess = true;
