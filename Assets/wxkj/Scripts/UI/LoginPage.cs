...
public class LoginPage : LoginPageBase {
    ...
    public void Start() 
    {
        ...
        //    detail.ShareSDK.authHandler = getUserInforCallback;
        //    Debug.Log("注册微信回调函数");
        //}
        //else
        //{
        //    Debug.Log("detail.ShareSDK 为空！！！！！！！！！s");
        //}
    ...
    void OnClickWX(){
        ...
        else
        {
            ...
            print("OnClickWX-GetAuthInfo" + MiniJSON.jsonEncode(authinfo));
            ...
            password = (string)authinfo["token"];
#endif
            print("OnClickWX-send username and password: " + username + "  " + password);
